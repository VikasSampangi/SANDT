...
public class Relations1 extends Fragment {
    ...
    private PDFView pdfView;public Relations1() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pir1);
        pdfView= (PDFView) view.findViewById(R.id.ir1);
        new RetrieverClass().execute(new Constants().url_gen_ir1 );
        return view;
    }
