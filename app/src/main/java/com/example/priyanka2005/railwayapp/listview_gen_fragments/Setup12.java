...
public class Setup12 extends Fragment {
    ...
    private PDFView pdfView;public Setup12() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pos12);
        pdfView= (PDFView) view.findViewById(R.id.os12);
        new RetrieverClass().execute(new Constants().url_gen_os12);
        return view;
    }
