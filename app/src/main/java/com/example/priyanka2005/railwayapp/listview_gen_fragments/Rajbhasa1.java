...
public class Rajbhasa1 extends Fragment {
    ...
    private PDFView pdfView;public Rajbhasa1() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.prbs1);
         pdfView= (PDFView) view.findViewById(R.id.rbs1);
        new RetrieverClass().execute(new Constants().url_gen_rajbhasa1 );
        return view;
    }
