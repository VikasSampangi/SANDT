...
public class Of1 extends Fragment {
    ...
    private PDFView pdfView;public Of1() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pofc1);
        pdfView= (PDFView) view.findViewById(R.id.ofc1);
        new RetrieverClass().execute(new Constants().url_tele_ofc1);
        return view;
    }
