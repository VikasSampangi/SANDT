...
public class Dc7 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_dc_7,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pdc7);
        pdfView= (PDFView) view.findViewById(R.id.dc7);
        new RetrieverClass().execute(new Constants().url_tele_dc7);
        return view;
    }
