...
public class Qc1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_qc_1, container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pqc1);
        pdfView= (PDFView) view.findViewById(R.id.qc1);
        new RetrieverClass().execute(new Constants().url_tele_qc1);
        return view;
