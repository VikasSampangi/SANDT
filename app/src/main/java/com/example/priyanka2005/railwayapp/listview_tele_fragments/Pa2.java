...
public class Pa2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_pa_2,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.ppas2);
        pdfView= (PDFView) view.findViewById(R.id.pas2);
        new RetrieverClass().execute(new Constants().url_tele_pas2);
        return view;
