...
public class Qc9 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_qc_9, container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pqc9);
        pdfView= (PDFView) view.findViewById(R.id.qc9);
        new RetrieverClass().execute(new Constants().url_tele_qc9);
        return view;
