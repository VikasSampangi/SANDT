...
public class Dl1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_dl_1,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pdn1);
        pdfView= (PDFView) view.findViewById(R.id.dn1);
        new RetrieverClass().execute(new Constants().url_tele_dn1);
        return view;
    }
