...
public class Of2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_of_2,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pofc2);
        pdfView= (PDFView) view.findViewById(R.id.ofc2);
        new RetrieverClass().execute(new Constants().url_tele_ofc2);
        return view;
    }
