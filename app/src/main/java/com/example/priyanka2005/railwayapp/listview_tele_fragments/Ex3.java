...
public class Ex3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_ex_3,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.ptex3);
        pdfView= (PDFView) view.findViewById(R.id.tex3);
        new RetrieverClass().execute(new Constants().url_tele_tex3);
        return view;
    }
