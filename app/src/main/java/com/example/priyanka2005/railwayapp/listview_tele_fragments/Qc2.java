...
public class Qc2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_qc_2, container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pqc2);
        pdfView= (PDFView) view.findViewById(R.id.qc2);
        new RetrieverClass().execute(new Constants().url_tele_qc2);
        return view;
