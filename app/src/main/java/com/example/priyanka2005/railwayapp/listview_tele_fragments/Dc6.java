...
public class Dc6 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_dc_6,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pdc6);
        pdfView= (PDFView) view.findViewById(R.id.dc6);
        new RetrieverClass().execute(new Constants().url_tele_dc6);
        return view;
    }
