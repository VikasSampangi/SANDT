...
public class Ins3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_ins_3,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pmi3);
        pdfView= (PDFView) view.findViewById(R.id.mi3);
        new RetrieverClass().execute(new Constants().url_tele_mi3);
        return view;
