...
public class Pa7 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_pa_7,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.ppas7);
        pdfView= (PDFView) view.findViewById(R.id.pas7);
        new RetrieverClass().execute(new Constants().url_tele_pas7);
        return view;
