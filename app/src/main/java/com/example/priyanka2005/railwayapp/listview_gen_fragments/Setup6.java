...
public class Setup6 extends Fragment {
    ...
    private PDFView pdfView;public Setup6() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pos6);
        pdfView= (PDFView) view.findViewById(R.id.os6);
        new RetrieverClass().execute(new Constants().url_gen_os6);
        return view;
    }
