...
public class Wp1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.gen_wp_1,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pgwp1);
        pdfView= (PDFView) view.findViewById(R.id.gwp1);
        new RetrieverClass().execute(new Constants().url_gen_wp1);
        return view;
    }
