...
public class Of6 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_of_6,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pofc6);
        pdfView= (PDFView) view.findViewById(R.id.ofc6);
        new RetrieverClass().execute(new Constants().url_tele_ofc6);
        return view;
