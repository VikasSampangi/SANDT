...
public class Of5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_of_5,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pofc5);
        pdfView= (PDFView) view.findViewById(R.id.ofc5);
        new RetrieverClass().execute(new Constants().url_tele_ofc5);
        return view;
