...
public class Ex2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_ex_2,container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.ptex2);
        pdfView= (PDFView) view.findViewById(R.id.tex2);
        new RetrieverClass().execute(new Constants().url_tele_tex2);
        return view;
    }
