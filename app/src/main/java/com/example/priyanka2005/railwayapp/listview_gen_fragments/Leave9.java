...
public class Leave9 extends Fragment {
    ...
    private PDFView pdfView;public Leave9() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pleaverules9 );
         pdfView= (PDFView) view.findViewById(R.id.leaverules9);
        new RetrieverClass().execute(new Constants().url_gen_lr9);
        return view;
    }
