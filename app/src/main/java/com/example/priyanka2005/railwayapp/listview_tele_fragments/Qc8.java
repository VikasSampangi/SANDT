...
public class Qc8 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate( R.layout.tele_qc_8, container,false );
        progressBar = (ProgressBar)view.findViewById( R.id.pqc8);
        pdfView= (PDFView) view.findViewById(R.id.qc8);
        new RetrieverClass().execute(new Constants().url_tele_qc8);
        return view;
