...
public class Leave3 extends Fragment {
    ...
    private PDFView pdfView;public Leave3() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pleaverules3);
       pdfView= (PDFView) view.findViewById(R.id.leaverules3);
        new RetrieverClass().execute(new Constants().url_gen_lr3);
        return view;
    }
