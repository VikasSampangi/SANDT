...
public class Setup4 extends Fragment {
    ...
    private PDFView pdfView;public Setup4() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = (ProgressBar)view.findViewById( R.id.pos4);
        pdfView= (PDFView) view.findViewById(R.id.os4);
        new RetrieverClass().execute(new Constants().url_gen_os4);
        return view;
    }
